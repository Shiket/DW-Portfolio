...
import {BottomLine, SectionName, ExternalLink, GatsbyIcon, InlineElements, InlineWrapper, StyledSvg, ContactWrapper, FooterIcons, StyledSpan } from '../../assets/styles/index'
